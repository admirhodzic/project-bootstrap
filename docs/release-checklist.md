...
- [x] Full checks pass from a clean checkout on supported OS/runtime combinations.
...
Commit `4a7aa0e` passed the GitHub Actions quality job, package portability on Ubuntu with Node.js 22 and 24, macOS with Node.js 24, Windows with Node.js 24, and CodeQL on 2026-09-05.
